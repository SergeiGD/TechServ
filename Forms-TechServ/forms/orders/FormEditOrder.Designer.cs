...
namespace Forms_TechServ.forms.orders
{
    partial class FormEditOrder
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.manageButton1 = new ManageButton();
            this.btnDoneService = new ManageButton();
            this.btnDeleteService = new ManageButton();
            this.btnAddService = new ManageButton();
            this.btnShowService = new ManageButton();
            this.btnEditSparePartBatches = new ManageButton();
            this.btnDelSparePart = new ManageButton();
            this.btnAddSparePart = new ManageButton();
            this.btnShowSparePart = new ManageButton();
            ...
            this.btnDelSparePart.Text = "Удалить выделенные";
